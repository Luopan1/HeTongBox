...
public class DrivingReportAdapter extends MBaseAdapter<String> {
    public DrivingReportAdapter(List<String> list, Activity mActivity) {
    ...
    public View getXView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mActivity).inflate(R.layout.item_driving_report, null);
