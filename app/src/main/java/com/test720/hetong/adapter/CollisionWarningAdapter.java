...
public class CollisionWarningAdapter extends MBaseAdapter<String> {
    public CollisionWarningAdapter(List<String> list, Activity mActivity) {
    ...
    public View getXView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mActivity).inflate(R.layout.item_collision_warning, null);
