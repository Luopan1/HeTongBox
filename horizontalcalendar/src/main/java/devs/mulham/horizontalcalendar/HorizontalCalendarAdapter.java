...
class HorizontalCalendarAdapter extends RecyclerView.Adapter<HorizontalCalendarAdapter.DayViewHolder> {
    ...
    public void onBindViewHolder(DayViewHolder holder, int position) {
        ...
        if (position == selectedItemPosition) {
            ...
            holder.year.setTextColor(horizontalCalendar.getTextColorSelected());
        ...
        // Unselected Days
            ...
            holder.year.setTextColor(horizontalCalendar.getTextColorNormal());
            if (Build.VERSION.SDK_INT >= 16) {
        ...
        holder.year.setText(DateFormat.format(horizontalCalendar.getFormatYear(), day).toString());
