...
public final class HorizontalCalendar {
    ...
    HorizontalCalendar(Builder builder) {
        ...
        this.calendar = builder.mCalendar;
    ...
    private void centerToPositionWithNoAnimation(final int position) {
        if (position != -1) {
            ...
            if (position > centerItem) {
                // TODO: 2017/11/27  changed when set datesNumberOnScreen(3)
                calendarView.scrollToPosition(position + shiftCells - 1);
            } else if (position < centerItem) {
    ...
    public static class Builder {
        ...
        public Builder setCalandar(Calendar calandar) {
            this.mCalendar = calandar;
            return this;
        }
